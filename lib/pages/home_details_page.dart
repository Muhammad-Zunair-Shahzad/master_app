...
class HomeDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(// Covers the whole screen just like material widget
      ...
      appBar: AppBar(), // By default provides back (< icon)
      ...
      ).h32(context), // Here I add padding of .p16() but we can also add height .h32(context) of the image instead of internal padding 
      Expanded(
      child: VxArc(
      ...
      child: Column(
      children: [
      catalog.name.text.xl4.bold.color(MyThemes.darkBluishColor).make(),
      catalog.desc.text.lg.textStyle(context.captionStyle).make(),
      ],
      ).p64(), // Due to arc name and description cut from the top so add padding inside the column
      ),
      ),
      ),
      ],
